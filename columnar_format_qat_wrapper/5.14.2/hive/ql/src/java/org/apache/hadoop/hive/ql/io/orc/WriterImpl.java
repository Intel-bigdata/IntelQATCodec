...
class WriterImpl implements Writer, MemoryManager.Callback {
  ...
  WriterImpl(FileSystem fs,
    ...
    codec = createCodec(compress, DIRECT_BUFFER_SIZE);
  ...
  // TODO Add codec buffer into consideration
  ...
  static CompressionCodec createCodec(CompressionKind kind, int bufferSize) {
    switch (kind) {
      case NONE:
        return null;
      case ZLIB:

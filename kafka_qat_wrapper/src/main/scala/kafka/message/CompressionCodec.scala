...
object CompressionCodec {
  def getCompressionCodec(codec: Int): CompressionCodec = {
    codec match {
      ...
      case QatCompressionCodec.codec => QatCompressionCodec
  ...
  def getCompressionCodec(name: String): CompressionCodec = {
    name.toLowerCase(Locale.ROOT) match {
      ...
      case QatCompressionCodec.name => QatCompressionCodec
...
object BrokerCompressionCodec {
  ...
  val brokerCompressionCodecs = List(UncompressedCodec, ZStdCompressionCodec, LZ4CompressionCodec, SnappyCompressionCodec, GZIPCompressionCodec, QatCompressionCodec, ProducerCompressionCodec)
...
case object QatCompressionCodec extends CompressionCodec with BrokerCompressionCodec {
  val codec = 5
  val name = "qat"
}
